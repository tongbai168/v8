...
$(OBJS): | $(builddir)/lib.target/libicuuc.so $(obj).target/third_party/icu/libicuuc.so
...
$(obj).target/third_party/icu/libicui18n.so: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/third_party/icu/libicui18n.so: LIBS := $(LIBS)
$(obj).target/third_party/icu/libicui18n.so: LD_INPUTS := $(OBJS) $(obj).target/third_party/icu/libicuuc.so
$(obj).target/third_party/icu/libicui18n.so: TOOLSET := $(TOOLSET)
$(obj).target/third_party/icu/libicui18n.so: $(OBJS) $(obj).target/third_party/icu/libicuuc.so FORCE_DO_CMD
	$(call do_cmd,solink)

all_deps += $(obj).target/third_party/icu/libicui18n.so
# Add target alias
.PHONY: icui18n
icui18n: $(builddir)/lib.target/libicui18n.so

# Copy this to the shared library output path.
$(builddir)/lib.target/libicui18n.so: TOOLSET := $(TOOLSET)
$(builddir)/lib.target/libicui18n.so: $(obj).target/third_party/icu/libicui18n.so FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/lib.target/libicui18n.so
# Short alias for building this shared library.
.PHONY: libicui18n.so
libicui18n.so: $(obj).target/third_party/icu/libicui18n.so $(builddir)/lib.target/libicui18n.so

# Add shared library to "all" target.
.PHONY: all
all: $(builddir)/lib.target/libicui18n.so
