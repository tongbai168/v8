...
OBJS := \
	$(obj).target/$(TARGET)/src/v8dll-main.o

# Add to the list of files we specially track dependencies for.
all_deps += $(OBJS)

# Make sure our dependencies are built before any of us.
$(OBJS): | $(obj).target/tools/gyp/libv8_base.a $(obj).target/tools/gyp/libv8_snapshot.a $(obj).target/tools/gyp/libv8_libbase.a $(builddir)/lib.target/libicui18n.so $(builddir)/lib.target/libicuuc.so $(obj).target/tools/gyp/js2c.stamp $(obj).target/third_party/icu/libicui18n.so $(obj).target/third_party/icu/libicuuc.so
