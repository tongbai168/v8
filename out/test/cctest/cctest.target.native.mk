...
$(OBJS): | $(obj).target/test/cctest/resources.stamp $(obj).target/tools/gyp/libv8_libplatform.a $(obj).target/tools/gyp/libv8_snapshot.a $(obj).target/tools/gyp/libv8_libbase.a $(obj).target/tools/gyp/libv8_base.a $(builddir)/lib.target/libicui18n.so $(builddir)/lib.target/libicuuc.so $(obj).target/tools/gyp/js2c.stamp $(obj).target/third_party/icu/libicui18n.so $(obj).target/third_party/icu/libicuuc.so
...
$(builddir)/cctest: LD_INPUTS := $(OBJS) $(obj).target/tools/gyp/libv8_libplatform.a $(obj).target/tools/gyp/libv8_snapshot.a $(obj).target/tools/gyp/libv8_libbase.a $(obj).target/tools/gyp/libv8_base.a $(obj).target/third_party/icu/libicui18n.so $(obj).target/third_party/icu/libicuuc.so
$(builddir)/cctest: TOOLSET := $(TOOLSET)
$(builddir)/cctest: $(OBJS) $(obj).target/tools/gyp/libv8_libplatform.a $(obj).target/tools/gyp/libv8_snapshot.a $(obj).target/tools/gyp/libv8_libbase.a $(obj).target/tools/gyp/libv8_base.a $(obj).target/third_party/icu/libicui18n.so $(obj).target/third_party/icu/libicuuc.so FORCE_DO_CMD
	$(call do_cmd,link)
