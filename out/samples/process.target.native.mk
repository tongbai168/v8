...
$(builddir)/process: LD_INPUTS := $(OBJS) $(obj).target/tools/gyp/libv8.so $(obj).target/tools/gyp/libv8_libplatform.a $(obj).target/third_party/icu/libicui18n.so $(obj).target/third_party/icu/libicuuc.so $(obj).target/tools/gyp/libv8_libbase.a
$(builddir)/process: TOOLSET := $(TOOLSET)
$(builddir)/process: $(OBJS) $(obj).target/tools/gyp/libv8.so $(obj).target/tools/gyp/libv8_libplatform.a $(obj).target/third_party/icu/libicui18n.so $(obj).target/third_party/icu/libicuuc.so $(obj).target/tools/gyp/libv8_libbase.a FORCE_DO_CMD
	$(call do_cmd,link)
