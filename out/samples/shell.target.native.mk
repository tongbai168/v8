...
$(builddir)/shell: LD_INPUTS := $(OBJS) $(obj).target/tools/gyp/libv8.so $(obj).target/tools/gyp/libv8_libplatform.a $(obj).target/third_party/icu/libicui18n.so $(obj).target/third_party/icu/libicuuc.so $(obj).target/tools/gyp/libv8_libbase.a
$(builddir)/shell: TOOLSET := $(TOOLSET)
$(builddir)/shell: $(OBJS) $(obj).target/tools/gyp/libv8.so $(obj).target/tools/gyp/libv8_libplatform.a $(obj).target/third_party/icu/libicui18n.so $(obj).target/third_party/icu/libicuuc.so $(obj).target/tools/gyp/libv8_libbase.a FORCE_DO_CMD
	$(call do_cmd,link)
